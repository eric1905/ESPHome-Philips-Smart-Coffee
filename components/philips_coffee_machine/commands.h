...
#define USE_DEFAULT_PHILIPS_COMMAND_SET
       ...
       const std::vector<uint8_t> command_pre_power_on =
            {0xD5, 0x55, 0x01, 0x01, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x18, 0x18};
        const std::vector<uint8_t> command_power_with_cleaning =
            {0xD5, 0x55, 0x02, 0x01, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x05, 0x2A};
        const std::vector<uint8_t> command_power_without_cleaning =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x2C, 0x09};
        const std::vector<uint8_t> command_power_off =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x01, 0x00, 0x00, 0x20, 0x04};
        const std::vector<uint8_t> command_press_play_pause =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x00, 0x00, 0x01, 0x24, 0x0D};
        /// @brief EP2220: Press Coffee Button
        const std::vector<uint8_t> command_press_1 =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x08, 0x00, 0x00, 0x04, 0x23};
        /// @brief EP2220: Press Espresso Button
        const std::vector<uint8_t> command_press_2 =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x02, 0x00, 0x00, 0x34, 0x12};
        /// @brief EP2220: Press Hot Water Button
        const std::vector<uint8_t> command_press_3 =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x04, 0x00, 0x00, 0x1C, 0x3E};
        /// @brief EP2220: Press Steam Button; EP2235 Press Cappuccino Button
        const std::vector<uint8_t> command_press_4 =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x10, 0x00, 0x00, 0x34, 0x19};
        const std::vector<uint8_t> command_press_bean =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x00, 0x02, 0x00, 0x34, 0x10};
        const std::vector<uint8_t> command_press_size =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x00, 0x04, 0x00, 0x1D, 0x3A};
        const std::vector<uint8_t> command_press_aqua_clean =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x00, 0x10, 0x00, 0x30, 0x09};
        const std::vector<uint8_t> command_press_calc_clean =
            {0xD5, 0x55, 0x00, 0x01, 0x00, 0x00, 0x03, 0x00, 0x20, 0x00, 0x15, 0x08};
#else
#define USE_DEFAULT_PHILIPS_COMMAND_SET
#endif
        ...
        /// @brief EP2220: Press Hot Water Button
        const std::vector<uint8_t> command_press_3 =
            {0xD5, 0x55, 0x00, 0x01, 0x02, 0x00, 0x02, 0x00, 0x00, 0x00, 0x11, 0x36};
        /// @brief EP2220: Press Steam Button; EP2235 Press Cappuccino Button
        const std::vector<uint8_t> command_press_4 =
